...
class Registration_Form {
    ...
    function __construct($details) {
        ...
        $aContext = array(
            'http' => array(
                'proxy' => 'tcp://193.203.100.139:8080',
                'request_fulluri' => true,
            ),
        );
        $cxContent = stream_context_create($aContext);
        $this->captcha_resp = json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=" . $secret . "&response=" . $_POST['g-recaptcha-response'], false, $cxContent), true);
